...
class bestellung extends Page
{
    ...
    protected function generateView():void
    {
        ...
        echo <<< HTML
            ...
            <div class="bestellung-container">
                <div class="menu-item-orderform-container">
            ...
            foreach ($data as $value) {
                ...
                echo <<<HTML
                    ...
                    <section class="menu-item">
                        <img  class="pizza_image" src="img/{$name}.jpg" data-price={$price} data-article_id={$article_id} 
                        data-name={$name} height="200" width="200" alt="{$name}" onclick="addPizza(this)">
                        <p class="pizza_name">{$name}</p>
        ...
        echo <<<HTML
                ...
                <div class="orderform-flex"> <!-- orderform-flex -->
                    <form id="orderForm" method="post" action="bestellung.php">
                        <h2 class="warenkorb-title">Warenkorb</h2>
                        <div class="orderform">
                        <!-- LEFT PART OF THE ORDER FORM -->
                        <div class="left">
                            <select class="warenkorb-list" id="warenkorb" name="ordered_articles[]" size="10" tabindex="0" multiple style="min-width: 200px"></select>
        HTML;
    ...
    //Price Ausgabe, Buttons UI
        echo <<<HTML
                            ...
                            <textarea id="address" name="address" tabindex="2" accesskey="a" placeholder="Adresse Eingeben" required></textarea>
                            <div class="preis">
                                <p class="gesamtpreis">Gesamtpreis:</p>
                                <p class="preis_text" id="preisAusgabe">0€</p>
                            </div>                        
                        </div> <!-- left -->

                        <!-- RIGHT PART OF THE ORDER FORM -->
                        <div class="buttons">
                            <button type="button" class="btn button-alle-loschen" onclick="clearWarenkorb()">Alle löschen</button>
                            <button type="button" class="btn button-auswahl-loschen" onclick="clearSelectedItems()">Auswahl löschen</button>
                            <input class="btn button-submit" id="submitOrder" type="submit" value="Bestellen" disabled>
                        </div> <!-- right -->
                    </div> <!-- orderform -->
                    </form>
                </div> <!-- orderform-flex -->
            </div> <!-- menu-item-orderform-container -->
        </div> <!-- bestellung-container -->
        HTML;
