...
abstract class Page
{
    ...
    protected function generatePageHeader(string $title = "", string $jsFile = "", bool $autoreload = false): void
    {
        ...
        $additionalStyles = '';
        if ($title === "Bestellung") {
            $additionalStyles = '<link rel="stylesheet" href="bestellung.styles.css?v=1.0">';
        } else if ($title === "Kunde") {
            $additionalStyles = '<link rel="stylesheet" href="kundeStyles.css?v=1.0">';
        } else if ($title === "Fahrer") {
            $additionalStyles = '<link rel="stylesheet" href="fahrer.styles.css?v=1.0">';
        } else if ($title === "Backer") {
            $additionalStyles = '<link rel="stylesheet" href="backer.styles.css?v=1.0">';
        }
        ...
        <html lang="de">
            <head>
                ...
                <title>EWA Pizza</title>
                <link rel="stylesheet" href="Page.styles.css?v=1.0">
                {$additionalStyles}
            ...
            <div class="navbar-container">
                <nav class="navbar">
                    <h2 class="navbar-title">EWA PIZZA</h2>
                    <button class="navbar-toggle" aria-label="Toggle menu">
                        &#9776; <!-- Hamburger icon -->
                    </button>
                    <ul class="navbar-menu">
                        <li class="navbar-item"><a href="backer.php">BÄCKER</a></li>
                        <li class="navbar-item"><a href="fahrer.php">FAHRER</a></li>
                        <li class="navbar-item"><a href="kunde.php">KUNDE</a></li>
                        <li class="bestellen"><a href="bestellung.php">BESTELLEN JETZT</a></li>
                    </ul>
                </nav>
            </div>
        HTML;
